...
def had_test_circuit_long(parameters): 
    # 그리고 대입 
    result2 = h_test_long_sym_ex.subs({a : parameters[0][0], b : parameters[0][1], c : parameters[0][2], d : parameters[1][0], e : parameters[1][1], f : parameters[1][2], g : parameters[2][0], h : parameters[2][1], i : parameters[2][2]})
    return result2

def specialh_circuit_short(parameters): 
    # 그리고 대입 
    result3 = specialh_short_sym_ex.subs({a : parameters[0][0], b : parameters[0][1], c : parameters[0][2], d : parameters[1][0], e : parameters[1][1], f : parameters[1][2], g : parameters[2][0], h : parameters[2][1], i : parameters[2][2]})
    return result3

def specialh_circuit_long(parameters):
    result4 = specialh_long_sym_ex.subs({a : parameters[0][0], b : parameters[0][1], c : parameters[0][2], d : parameters[1][0], e : parameters[1][1], f : parameters[1][2], g : parameters[2][0], h : parameters[2][1], i : parameters[2][2]})
    return result4
...
# print(had_test_circuit([[0, 0, 0], [0, 0, 0], [0, 0, 0]]))
